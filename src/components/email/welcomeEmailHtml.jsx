// Shared welcome-email HTML template — used both by the backend sender
// (sendWelcomeEmail) and the frontend preview (EmailThreadPanel synthetic message).
// Keeping a single source of truth so they don't drift.
