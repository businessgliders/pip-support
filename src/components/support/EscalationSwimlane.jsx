...
export default function EscalationSwimlane({ currentUser, openSignal = 0, tickets = [] } = {}) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed md:bottom-12 md:top-auto top-1/2 -translate-y-1/2 md:translate-y-0 right-0 z-50 flex items-stretch transition-transform duration-300 ease-out ${
