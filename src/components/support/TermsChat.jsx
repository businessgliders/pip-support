    ...
    <>
      ...
      {open && (
        <div
          ...
          className="fixed md:!bottom-5 right-5 md:right-[440px] z-50 w-[calc(100vw-2.5rem)] sm:w-[420px] h-[640px] max-h-[calc(100vh-6rem)] md:max-h-[calc(100vh-2.5rem)] flex flex-col rounded-2xl bg-white shadow-2xl border border-slate-200 overflow-hidden animate-in slide-in-from-bottom-4 duration-200"
        >
