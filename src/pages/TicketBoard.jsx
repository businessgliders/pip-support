        ...
        {showArchived ? (
          ...
          <DragDropContext onDragEnd={handleDragEnd}>
            ...
            <div
              ...
              className="flex lg:grid lg:grid-cols-4 gap-4 md:gap-6 overflow-x-auto lg:overflow-visible -mx-4 md:-mx-8 pl-4 pr-4 md:pl-10 md:pr-8 pb-2 lg:mx-0 lg:pl-0 lg:pr-0 lg:pb-0 snap-x snap-mandatory lg:snap-none lg:flex-1 lg:min-h-0 scroll-smooth touch-pan-x overscroll-x-contain"
            >
              {columns.map((column) => (
