          ...
          <div className="flex gap-2 md:gap-3 flex-nowrap md:flex-wrap items-center justify-end">
            ...
            <div className="hidden md:block">
              <Input
                ...
                className="backdrop-blur-md bg-white/70 border-white/80 text-gray-900 placeholder:text-gray-600 rounded-xl h-11 w-40 lg:w-64"
              />
            </div>
        ...
        {showArchived ? (
          ...
          <DragDropContext onDragEnd={handleDragEnd}>
            ...
            <div
              ...
              className="flex lg:grid lg:grid-cols-4 gap-4 md:gap-6 overflow-x-auto lg:overflow-visible -mx-4 md:-mx-8 pl-4 pr-4 md:pl-10 md:pr-8 pb-2 lg:mx-0 lg:pl-0 lg:pr-0 lg:pb-0 snap-x snap-mandatory scroll-pl-4 md:scroll-pl-10 lg:snap-none lg:flex-1 lg:min-h-0 scroll-smooth touch-pan-x overscroll-x-contain"
            >
              {columns.map((column) => (
