    ...
    try {
      ...
      try {
        await base44.integrations.Core.SendEmail({
          ...
          subject: `New Ticket Assigned: ${formData.client_name}`,
          body: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: linear-gradient(135deg, #f1899b 0%, #f7b1bd 50%, #fbe0e2 100%); padding: 40px 20px;">
              <div style="background: white; border-radius: 20px; padding: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                ...
                <div style="background: linear-gradient(135deg, #f1899b20, #fbe0e220); border-left: 4px solid #f1899b; padding: 20px; border-radius: 10px; margin-bottom: 20px;">
                  ...
                  <p style="margin: 8px 0; color: #555;"><strong>Inquiry Type:</strong> ${formData.inquiry_type}</p>
                  ...
                  <p style="margin: 8px 0; color: #555;"><strong>Priority:</strong> <span style="background: ${formData.inquiry_type === "Cancellation" ? '#ffebee' : '#fff3e0'}; padding: 4px 12px; border-radius: 12px; color: ${formData.inquiry_type === "Cancellation" ? '#c62828' : '#e65100'};">${formData.inquiry_type === "Cancellation" ? "High" : "Medium"}</span></p>
                </div>
                
                ${formData.notes ? `
                  <div style="background: #f8f9fa; padding: 15px; border-radius: 10px; margin-bottom: 20px;">
                    <p style="color: #666; margin: 0 0 8px 0; font-weight: 600;">Additional Notes:</p>
                    <p style="color: #555; margin: 0; white-space: pre-wrap;">${formData.notes}</p>
                  </div>
                ` : ''}
